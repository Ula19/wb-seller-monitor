...
class Settings(BaseSettings):
    ...
    # схемы socks5h:// или http://). Магазины делятся по слотам параллельно; слот
    # магазина обслуживает и каталог, и b2b-detail. Класс/гео IP не важны нигде
    # (проверено 2026-07-17: __internal 200 с DC/резидентных/direct при живой куке) —
    # бери любые дешёвые, важен только суммарный темп на IP.
    wb_proxies: str = ""
